function initializeBuoy(cb){
  ...
  $.get("/home?user="+ (getUser() ? getUser().uuid : null), function(data){
    ...
    if(data.bulletins && data.bulletins.length > 0){
      data.bulletins.forEach(function(bulletin, i){
        if(i > 15){
          return;
        }
...
async function donate(){
  ...
  const priceFeed = new web3.eth.Contract(aggregatorV3InterfaceABI2, "0xc59E3633BAAC79493d908e63626716e204A45EdF")
  priceFeed.methods
  .latestRoundData()
  .call()
  .then(async roundData => {
    ...
    var contractAddress = "0x779877A7B0D9E8603169DdbD7836e478b4624789"
